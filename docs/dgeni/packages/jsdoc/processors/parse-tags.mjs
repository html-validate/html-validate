import TagCollection from "../lib/tag-collection.mjs";
...
function parseTagsProcessor(log, createDocMessage, backTickParserAdapter, htmlBlockParserAdapter) {
	return {
		tagDefinitions: [],
...
export default parseTagsProcessor;
